...
<head>
    ...
    <link rel="stylesheet" href="../../admin/appointment/ styles.css">
</head>
                    ...
                    <div class="card table-with-links">
                        <div class="card-header">
                            <div>
                                ...
                                <div class="float-end">
                                    <a href="../../admin/appointment/pending.php" class="btn btn-info btn-round">Show Pending Appointments</a>
                                    <a href="../../admin/print/printAppointment.php" class="btn btn-secondary btn-round">Print <i class="fa fa-print"></i></a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                    // Limit the reason to 20 characters and add ellipsis if it's longer
                                                    $appointmentReason = $row['appointment_reason'];
                                                    echo (strlen($appointmentReason) > 20) ? substr($appointmentReason, 0, 20) . '...' : $appointmentReason;
                                                    ?>
                                                </td>
