            ...
            <form action="../../includes/admin/patientManagementController.php" method="post">
              ...
              <div class="row">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="patient_referral" name="patient_referral" placeholder="Place of referral ... ">
                </div>
              </div>
              <div class="row">
                <div class="form-group">
              ...
              <button type="submit" name="add_record" class="btn btn-primary btn-round float-start" id="addPatientRecord">Add Record</button>
              <div class="float-end" id="buttonShowPrint">
                  <a href="../../admin/patient/index.php" class="btn btn-info btn-round">Show Patient Records</a>
                  <a href="../../admin/print/printPatientForm.php" class="btn btn-secondary btn-round">Print <i class="fa fa-print"></i></a>
              </div>
            </form>
          </div>
        </div>
